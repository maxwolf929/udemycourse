...
class ChefTest < ActiveSupport::TestCase
  ...
  def setup
    @chef = Chef.new(chefname: "Tata", email: "tata@papa.com")
  end
  ...
  test "email validtaion should accept valid addresses" do
  ...
  test "email validtaion should reject invalid addresses" do
